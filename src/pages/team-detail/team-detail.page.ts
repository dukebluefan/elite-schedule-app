...
export class TeamDetailPage {
  ...
  constructor(
    ...
    console.log("TeamDetailsPage: team: ", this.team);
}
    ionViewWillEnter() {
        console.log("TeamDetailsPage:ionViewWillEnter()");
        this.ionViewLoaded();
    }

  ionViewLoaded() {
    this.tourneyData = this.eliteApi.getCurrentTourney();
    console.log("TeamDetailsPage:ionViewLoaded(): tourneyData: ", this.tourneyData);
    ...
    this.games = _.chain(this.tourneyData.games)
                  ...
                  .value();
    console.log("TeamDetailsPage:ionViewLoaded(): games: ", this.games);
